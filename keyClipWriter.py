...
class KeyClipWriter:
        ...
        def start(self, outputPath, fourcc, fps):
                ...
                global filepath
                global filename
                global file_no_extension
                filepath = outputPath
                filename = filepath[7:]
                file_no_extension = filename[:-4]
        ...
        def upload(self):
                ...
                global data
                global storage                
                data = {file_no_extension:filename}
                database.child("medialinks").update(data,user['idToken'])
                storage.child(filename).put(filepath,user['idToken'])
